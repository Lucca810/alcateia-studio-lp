        ...
        <div className='main'>
            ...
            <section id="servicos" className='servicos-section' style={{ backgroundImage: "url('/Banner2.jpg')" }}>
                ...
                <div className='servicos-section--blocs-area'>
                    {services.map((service, idx) => { return <RoundedBlock key={idx} imgUrl={service.imgUrl} title={service.title} animated={true} direction={size[0] > 911 ? 'B' : (idx % 2 === 0 ? 'L' : 'R')} startAnimation={size[0] > 911 ? 15 : 10} scroll={scroll} /> })}
                </div>
            </section>
            <section id="portifolio" className='portifolio-section' style={{ backgroundImage: "url('/Banner3.jpg')" }}>
                ...
                <div className='portifolio-section--blocs-area'>
                    {cases.map((caseSel, idx) => { return <RoundedBlock key={idx} imgUrl={caseSel.imgUrl} title={caseSel.title} subheading={caseSel.subheading} goTo={caseSel.goTo} animated={true} direction={size[0] > 911 ? 'B' : (idx % 2 === 0 ? 'L' : 'R')} startAnimation={size[0] > 911 ? 40 : 50} scroll={scroll} /> })}
                </div>
            </section>
